...
;* Date/Time created: Fri Feb 26 14:57:57 2016                                *
;******************************************************************************
...
;	C:\DSP_Systems\bin\opt6x.exe C:\\Users\\pk0300\\AppData\\Local\\Temp\\088082 C:\\Users\\pk0300\\AppData\\Local\\Temp\\088084 
	.sect	".text"
	.clink
	.global	LMS_isrNoOpt
...
;*                                                                            *
;*   Regs Modified     : A3,A4,A5,A6,A7,A8,A9,A16,A17,B4,B5,B6,B7             *
;*   Regs Used         : A3,A4,A5,A6,A7,A8,A9,A16,A17,B3,B4,B5,B6,B7,DP       *
...
$C$DW$11	.dwtag  DW_TAG_variable, DW_AT_name("newvalue")
	...
	.dwattr $C$DW$11, DW_AT_location[DW_OP_regx 0x26]
	.dwcfi	cfa_offset, 0
	.dwpsn	file "../Adaptive.c",line 21,column 10,is_stmt,isa 0

           MVKL    .S2     h,B7              ; [B_Sb66] 
||         MVK     .L2     2,B5              ; [B_L66] |21| 

	.dwpsn	file "../Adaptive.c",line 16,column 2,is_stmt,isa 0

           MVC     .S2     B5,ILC            ; [B_Sb66] 
||         MVKL    .S1     X,A16             ; [A_S66] |16| 

	.dwpsn	file "../Adaptive.c",line 7,column 1,is_stmt,isa 0

           MVKH    .S1     X,A16             ; [A_S66] |16| 
||         MVKH    .S2     h,B7              ; [B_Sb66] 
||         MV      .L1     A4,A17            ; [A_L66] |7| 

;*----------------------------------------------------------------------------*
;*   SOFTWARE PIPELINE INFORMATION
;*
;*      Loop found in file               : ../Adaptive.c
;*      Loop source line                 : 21
...
$C$L1:    ; PIPED LOOP PROLOG
	.dwpsn	file "../Adaptive.c",line 16,column 2,is_stmt,isa 0
           ...
           SPLOOPD         2                 ;12 ; [A_S66] (P) 
||         STH     .D1T1   A17,*A16(0)       ; [A_D64P] |16| 
||         MV      .L2X    A16,B5            ; [B_L66] |16| 
||         MV      .L1X    B7,A8             ; [A_L66] 
...
$C$L2:    ; PIPED LOOP KERNEL
	.dwpsn	file "../Adaptive.c",line 22,column 3,is_stmt,isa 0
           ...
           LDW     .D2T2   *B5++(4),B4       ; [B_D64P] |22| (P) <0,0> 
||         LDW     .D1T1   *A8++(4),A7       ; [A_D64P] |22| (P) <0,0> 

           NOP             4                 ; [A_L66] 
           MPY2    .M1X    A7,B4,A5:A4       ; [A_M66] |22| (P) <0,5> 
           NOP             3                 ; [A_L66] 
	.dwpsn	file "../Adaptive.c",line 21,column 10,is_stmt,isa 0
...
||^        ZERO    .L1     A3                ; [A_L66] |21| 
||^        ZERO    .L2     B6                ; [B_L66] |21| 
||         DSHL    .S1     A5:A4,1,A7:A6     ; [A_S66] |22| (P) <0,9> 

	.dwpsn	file "../Adaptive.c",line 22,column 3,is_stmt,isa 0
           ADD     .L1     A7,A3,A3          ; [A_L66] |22| <0,10> 

           SPKERNEL        0,0               ; [] 
||         ADD     .L2X    A6,B6,B6          ; [B_L66] |22| <0,11> 

;** --------------------------------------------------------------------------*
$C$L3:    ; PIPED LOOP EPILOG
	.dwpsn	file "../Adaptive.c",line 25,column 2,is_stmt,isa 0

           ADDAH   .D2     B7,7,B5           ; [B_D64P] 
||         MVK     .S1     372,A8            ; [A_S66] |25| 
||         MVK     .L2     6,B7              ; [B_L66] |27| 

           MVC     .S2     B7,ILC            ; [B_Sb66] 
           NOP             5                 ; [A_L66] 
           ADDAH   .D1     A16,7,A4          ; [A_D64P] 
           SUB     .S1     A4,2,A5           ; [A_S66] 
           MV      .L1     A4,A6             ; [A_L66] 
;** --------------------------------------------------------------------------*
           NOP             1                 ; [A_L66] 
           ADD     .L1X    B6,A3,A9          ; [A_L66] 
	.dwpsn	file "../Adaptive.c",line 24,column 2,is_stmt,isa 0
           SHR     .S1     A9,16,A7          ; [A_S66] |24| 
;*----------------------------------------------------------------------------*
;*   SOFTWARE PIPELINE INFORMATION
;*
;*      Loop found in file               : ../Adaptive.c
...
$C$L4:    ; PIPED LOOP PROLOG
           ...
           SPLOOPD         3                 ;12 ; [A_S66] (P) 
||         SUB     .L1     A17,A7,A16        ; [A_L66] |24| 
...
$C$L5:    ; PIPED LOOP KERNEL
	.dwpsn	file "../Adaptive.c",line 25,column 2,is_stmt,isa 0
           ...
           SPMASK                            ; [] 
||^        MPY     .M1     A16,A8,A7         ; [A_M66] |25| 
||         LDH     .D1T1   *A6++(-2),A8      ; [A_D64P] |29| (P) <0,0> 
...
||^        MV      .L2     B5,B6             ; [B_L66] 
	...
	.dwpsn	file "../Adaptive.c",line 29,column 3,is_stmt,isa 0
           LDH     .D2T2   *B6++(-2),B4      ; [B_D64P] |29| (P) <0,3> 
	.dwpsn	file "../Adaptive.c",line 25,column 2,is_stmt,isa 0

           SPMASK                            ; [] 
||^        STW     .D2T1   A9,*+DP(Y)        ; [B_D64P] 
||^        EXT     .S1     A7,1,16,A7        ; [A_S66] |25| 

	.dwpsn	file "../Adaptive.c",line 29,column 3,is_stmt,isa 0

           LDH     .D1T1   *A5++(-2),A8      ; [A_D64P] |30| (P) <0,5> 
||         MPY     .M1     A7,A8,A3          ; [A_M66] |29| (P) <0,5> 

           NOP             1                 ; [A_L66] 
	.dwpsn	file "../Adaptive.c",line 24,column 2,is_stmt,isa 0

           SPMASK                            ; [] 
||^        STW     .D2T1   A16,*+DP(E)       ; [B_D64P] |24| 
||         SHR     .S1     A3,15,A3          ; [A_S66] |29| (P) <0,7> 

           NOP             1                 ; [A_L66] 
	.dwpsn	file "../Adaptive.c",line 29,column 3,is_stmt,isa 0
           ADD     .L2X    A3,B4,B4          ; [B_L66] |29| <0,9> 

           SPKERNEL        1,0               ; [] 
||         STH     .D1T1   A8,*A4++(-2)      ; [A_D64P] |30| <0,10> 
||         STH     .D2T2   B4,*B5++(-2)      ; [B_D64P] |29| <0,10> 
...
$C$DW$12	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$12, DW_AT_TI_return
           RETNOP          B3,4              ; [] |40| 
	.dwpsn	file "../Adaptive.c",line 37,column 2,is_stmt,isa 0
           SHR     .S1     A9,16,A4          ; [A_S66] |37| 
	.dwpsn	file "../Adaptive.c",line 40,column 1,is_stmt,isa 0
           ; BRANCH OCCURS {B3}              ; [] |40| 
