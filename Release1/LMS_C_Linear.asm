...
;* Date/Time created: Sat Mar 05 22:17:30 2016                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../LMS_C_Linear.c")
...
$C$DW$6	.dwtag  DW_TAG_subprogram, DW_AT_name("LinearAssembly1")
	.dwattr $C$DW$6, DW_AT_TI_symbol_name("LinearAssembly1")
	.dwattr $C$DW$6, DW_AT_type(*$C$DW$T$10)
	.dwattr $C$DW$6, DW_AT_declaration
	.dwattr $C$DW$6, DW_AT_external
	.dwattr $C$DW$6, DW_AT_decl_file("../LMS_C_Linear.c")
...
$C$DW$7	.dwtag  DW_TAG_variable, DW_AT_name("hCsa")
	...
	.dwattr $C$DW$7, DW_AT_decl_file("../LMS_C_Linear.c")
...
$C$DW$8	.dwtag  DW_TAG_variable, DW_AT_name("XCsa")
	...
	.dwattr $C$DW$8, DW_AT_decl_file("../LMS_C_Linear.c")
...
$C$DW$9	.dwtag  DW_TAG_variable, DW_AT_name("YCsa")
	...
	.dwattr $C$DW$9, DW_AT_decl_file("../LMS_C_Linear.c")
...
$C$DW$10	.dwtag  DW_TAG_variable, DW_AT_name("ECsa")
	...
	.dwattr $C$DW$10, DW_AT_decl_file("../LMS_C_Linear.c")
	.dwattr $C$DW$10, DW_AT_decl_line(0x08)
	.dwattr $C$DW$10, DW_AT_decl_column(0x05)
;	C:\ti\ccsv6\tools\compiler\ti-cgt-c6000_8.0.1\bin\acpia6x.exe -@C:\\Users\\dr15755\\AppData\\Local\\Temp\\0688814 
	.sect	".text"
	.clink
	.global	LMS_C_Linear
...
$C$DW$18	.dwtag  DW_TAG_variable, DW_AT_name("temp")
	...
	.dwpsn	file "../LMS_C_Linear.c",line 19,column 2,is_stmt,isa 0
	.dwpsn	file "../LMS_C_Linear.c",line 20,column 2,is_stmt,isa 0
	.dwpsn	file "../LMS_C_Linear.c",line 26,column 2,is_stmt,isa 0
           LDH     .D2T2   *SP(4),B0         ; [B_D64P] |26| 
           NOP             4                 ; [A_L66] 
           STW     .D2T2   B0,*SP(20)        ; [B_D64P] |26| 
	.dwpsn	file "../LMS_C_Linear.c",line 28,column 2,is_stmt,isa 0
           LDH     .D2T2   *SP(20),B0        ; [B_D64P] |28| 
           MVKL    .S2     XCsa,B4           ; [B_Sb66] |28| 
           MVKH    .S2     XCsa,B4           ; [B_Sb66] |28| 
           NOP             2                 ; [A_L66] 
           STH     .D2T2   B0,*B4(0)         ; [B_D64P] |28| 
	.dwpsn	file "../LMS_C_Linear.c",line 29,column 2,is_stmt,isa 0
           MV      .L1X    B4,A4             ; [A_L66] 
           LDH     .D1T1   *A4(0),A0         ; [A_D64P] |29| 
           NOP             4                 ; [A_L66] 
           STH     .D2T1   A0,*SP(16)        ; [B_D64P] |29| 
	.dwpsn	file "../LMS_C_Linear.c",line 30,column 2,is_stmt,isa 0
           ZERO    .L1     A0                ; [A_L66] |30| 
           STW     .D2T1   A0,*+DP(YCsa)     ; [B_D64P] |30| 
	.dwpsn	file "../LMS_C_Linear.c",line 33,column 2,is_stmt,isa 0
           MVKL    .S1     hCsa,A4           ; [A_S66] |33| 
$C$DW$19	.dwtag  DW_TAG_TI_branch
	.dwattr $C$DW$19, DW_AT_low_pc(0x00)
	.dwattr $C$DW$19, DW_AT_name("LinearAssembly1")
	.dwattr $C$DW$19, DW_AT_TI_call

           CALLP   .S2     LinearAssembly1,B3 ; [B_Sb66] |33| 
||         MVK     .L1     8,A6              ; [A_L66] |33| 
||         MVKH    .S1     hCsa,A4           ; [A_S66] |33| 

$C$RL0:    ; CALLP OCCURS {LinearAssembly1} {0}  ; [] |33| 
           STW     .D2T1   A4,*+DP(YCsa)     ; [B_D64P] |33| 
	.dwpsn	file "../LMS_C_Linear.c",line 35,column 2,is_stmt,isa 0
           LDH     .D2T2   *SP(16),B0        ; [B_D64P] |35| 
           LDH     .D2T2   *+DP(YCsa+2),B1   ; [B_D64P] |35| 
           NOP             4                 ; [A_L66] 
           SUB     .L2     B0,B1,B0          ; [B_L66] |35| 
           STW     .D2T2   B0,*+DP(ECsa)     ; [B_D64P] |35| 
	.dwpsn	file "../LMS_C_Linear.c",line 36,column 2,is_stmt,isa 0
...
||         MVK     .S2     116,B0            ; [B_Sb66] |36| 
	...
	.dwpsn	file "../LMS_C_Linear.c",line 40,column 6,is_stmt,isa 0
           MVK     .L2     7,B0              ; [B_L66] |40| 
           STW     .D2T2   B0,*SP(8)         ; [B_D64P] |40| 
	.dwpsn	file "../LMS_C_Linear.c",line 40,column 14,is_stmt,isa 0
...
;** --------------------------------------------------------------------------*
$C$L1:    
	.dwpsn	file "../LMS_C_Linear.c",line 44,column 3,is_stmt,isa 0
...
||         LDH     .D2T2   *+B6[B1],B1       ; [B_D64P] |44| 
	...
	.dwpsn	file "../LMS_C_Linear.c",line 45,column 3,is_stmt,isa 0
	...
	.dwpsn	file "../LMS_C_Linear.c",line 40,column 18,is_stmt,isa 0
...
;** --------------------------------------------------------------------------*
$C$L2:    
	.dwpsn	file "../LMS_C_Linear.c",line 48,column 2,is_stmt,isa 0
           LDH     .D2T2   *+DP(YCsa+2),B0   ; [B_D64P] |48| 
           NOP             4                 ; [A_L66] 
           STH     .D2T2   B0,*SP(12)        ; [B_D64P] |48| 
	.dwpsn	file "../LMS_C_Linear.c",line 50,column 2,is_stmt,isa 0
           LDH     .D2T1   *SP(12),A4        ; [B_D64P] |50| 
           NOP             4                 ; [A_L66] 
	.dwpsn	file "../LMS_C_Linear.c",line 52,column 1,is_stmt,isa 0
...
$C$DW$20	.dwtag  DW_TAG_TI_branch
	...
	.dwattr $C$DW$20, DW_AT_TI_return
           RETNOP          B3,5              ; [] |52| 
           ; BRANCH OCCURS {B3}              ; [] |52| 
	.dwattr $C$DW$11, DW_AT_TI_end_file("../LMS_C_Linear.c")
...
$C$DW$T$29	.dwtag  DW_TAG_typedef, DW_AT_name("__builtin_va_list")
	...
	.dwattr $C$DW$T$29, DW_AT_decl_file("../LMS_C_Linear.c")
